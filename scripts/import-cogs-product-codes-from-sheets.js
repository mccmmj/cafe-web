...
/**
 * Runner for scripts/import-cogs-product-codes-from-sheets.ts (transpile on the fly).
 */
...
const entryPath = path.join(__dirname, 'import-cogs-product-codes-from-sheets.ts')
